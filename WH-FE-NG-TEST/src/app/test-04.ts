...
@Component({
    ...
    template : `
                ...
                <div>
                    <input type="text" id="firstname" [(ngModel)]="firstname" (blur)="generateName()">
                    <input type="text" id="lastname" [(ngModel)]="lastname" (blur)="generateName()">
                    <span id="output">{{fullname}}</span>
                </div>
                `,
    styles : []
})
